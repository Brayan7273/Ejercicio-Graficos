package mx.edu.utng.bggg.meditationtracker.ui.theme
...
fun getColorForSessionType(type: mx.edu.utng.bggg.meditationtracker.data.database.SessionType): Color {
    return when(type) {
        mx.edu.utng.bggg.meditationtracker.data.database.SessionType.MEDITATION -> MeditationColor
        mx.edu.utng.bggg.meditationtracker.data.database.SessionType.BREATHING -> BreathingColor
        mx.edu.utng.bggg.meditationtracker.data.database.SessionType.YOGA -> YogaColor
        mx.edu.utng.bggg.meditationtracker.data.database.SessionType.JOURNALING -> JournalingColor
        mx.edu.utng.bggg.meditationtracker.data.database.SessionType.GRATITUDE -> GratitudeColor
    }
}
